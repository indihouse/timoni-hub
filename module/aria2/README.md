...
A [timoni.sh](http://timoni.sh) module for deploying aria2 to Kubernetes clusters.
...
```shell
timoni -n default apply aria2 oci://<container-registry-url>
```
